...
const Chat = () => {
  ...
  return (
    <div>
      <div
        className={`fixed bottom-0 z-20 right-0 w-full sm:w-128 min-h-120 z-1 bg-white border border-gray-300 shadow-lg transform transition-transform duration-300 ${
